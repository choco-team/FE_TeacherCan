...
function RandomPick() {
  return (
    <S.RandomPickLayout>
      ...
      <Container>
        <Layout>
          <ConditionBox Icon={HiUserGroup} String="대상" disableCursor={true} />
        </Layout>
        <CheckBox name={'기존 명단'} />
      ...
      <Container>
        <Layout>
          <ConditionBox Icon={TiFlowMerge} String="방식" disableCursor={true} />
        </Layout>
      ...
      <Container>
        <Layout>
          <ConditionBox Icon={BsEye} String="대상 설정" disableCursor={true} />
        </Layout>
